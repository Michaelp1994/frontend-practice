...
import FirstPictureSection from "./components/FirstPictureSection";
import SecondPictureSection from "./components/SecondPictureSection";
import VideoSection from "./components/VideoSection";
import ThirdPictureSection from "./components/ThirdPictureSection";
import FourthPictureSection from "./components/FourthPictureSection";
import GlobalStyles from "./components/GlobalStyles";
const fullSizePictureSrc =
  "https://images.unsplash.com/photo-1627773755683-dfcf2774596a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1152&q=80";
const App = () => {
  return (
    <Wrapper>
      <GlobalStyles />
      ...
      <Main>
        ...
        <FullSizePicture src={fullSizePictureSrc} />
        <TextWrapper>
          <Heading>
          ...
          <Text>
            ...
            opportunities to learn from and with each other. Alongside an
            internal training program, employees are actively supported in
            acquiring new knowledge and skills, and coached on applying these in
